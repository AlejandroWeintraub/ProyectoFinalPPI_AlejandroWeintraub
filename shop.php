...
<script>
                                        ...
                                        <div class="card-body p-4">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-7">
                                                    ...
                                                    $query = "SELECT p.ID_Producto,Nombre, Descripcion, c.cantidad, precio FROM Carrito c, Product p WHERE p.ID_Producto = c.ID_Producto and id_usuario = $user_id";
                                                    ...
                                                    while ($row = mysqli_fetch_array($result)) {
                                                        ...
                                                        <form action="eliminardelcarrito.php" method="post">
                                                            <div class="d-flex justify-content-between">
                                                                <div class="d-flex flex-row align-items-center">
                                                                    ...
                                                                    <div class="ms-3">
                                                                        <h5>' . $row['Nombre'] . '</h5>
                                                                        <p class="small mb-0">' . $row['Descripcion'] . '</p>
                                                                    </div>
                                                                </div>
                                                                <div class="d-flex flex-row align-items-center">
                                                                    <div style="width:na 50px;">
                                                                        <h5 class="fw-normal mb-0">' . $cantidad . '</h5>
                                                                    </div>
                                                                    <div style="width: 80px;">
                                                                        <h5 class="mb-0">&nbsp; &nbsp$' . $precio . '</h5>
                                                                    </div>
                                                        ...
                                                        $total = $total + intval($row['cantidad']) * floatval($row['precio']);
                                                    }
                                                    ?>
    ...
    <!-- Profile Modal -->
    <div class="modal fade bg-white" id="ProfileModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                            ...
                            <div class="card rounded-0">
                                ...
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    <ul class="list-unstyled">
                                        ...
                                        <li><button type="submit" name="add_to_cart" class="btn btn-success text-white mt-2"><i class="fas fa-cart-plus"></i> </button></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="card-body">
                                <a href="shop-single.html" class="h3 text-decoration-none">' . $row['Nombre'] . '</a>
